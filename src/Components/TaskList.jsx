...
const TaskList = ({ data }) => {
    ...
    return (<>
        <li className={`border rounded-xl shadow-md p-5 flex items-center gap-5 text-black ${data.priority === 'High' && 'bg-emerald-400' || data.priority === 'Medium' && 'bg-amber-300' || data.priority === 'Low' && 'bg-red-300'}`}>
            <div className="w-80">
            ...
            <div className="w-32">
                {
                    data.isComplete ?
                        <button disabled  className="w-full text-indigo-600 bg-indigo-100 py-2 text-base font-medium rounded">
                            &#10003; Completed
                        </button>
                        :
                        <button
            ...
            <div className="ml-4 w-max flex items-center gap-6">
                <button
                    className='w-full text-gray-700 hover:text-indigo-600 duration-200'
                ...
                <button
                    className='w-full text-gray-700 hover:text-red-600 duration-200'
